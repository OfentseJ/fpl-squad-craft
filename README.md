...
1. **Create a new repository on GitHub**
   ...
   - Name it `fpl-react-hub` (or any name you prefer)
   - Make it public
...
# Commit
git commit -m "Initial commit: FPL React Hub"

# Add remote repository
git remote add origin https://github.com/YOUR_USERNAME/fpl-react-hub.git
...
export default defineConfig({
  plugins: [react()],
  base: "/fpl-react-hub/", // Replace with your repo name
});
```
...
Your app will be live at: `https://YOUR_USERNAME.github.io/fpl-react-hub/`
