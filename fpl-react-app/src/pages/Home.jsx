...
export default function Home({ data }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-center">
      <h2 className="text-4xl font-bold mb-4">Fantasy Premier League Tools</h2>
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
        View FPL statistics, live match contributions, explore transfer trends,
        and plan your team using real-time Fantasy Premier League data.
      </p>
