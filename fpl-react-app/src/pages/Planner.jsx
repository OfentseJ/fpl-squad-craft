...
export default function Planner({ data }) {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-linear-to-r from-purple-600 to-green-600 text-white p-4 sm:p-6 rounded-lg sm:rounded-xl mb-4 sm:mb-6 shadow-lg">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-center">
          <div>
            <div className="text-2xl sm:text-3xl font-bold">
              {squad.length}/15
            </div>
            <div className="text-xs sm:text-sm text-white/80">Squad</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl font-bold">
              {startingCount}/11
            </div>
            <div className="text-xs sm:text-sm text-white/80">Starting XI</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl font-bold">
              £{totalCost.toFixed(1)}m
            </div>
            <div className="text-xs sm:text-sm text-white/80">Total Cost</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl font-bold">
              £{(100 - totalCost).toFixed(1)}m
            </div>
            <div className="text-xs sm:text-sm text-white/80">Remaining</div>
          </div>
        </div>
      </div>
      ...
      {squad.length >= 11 && (
        <div className="mb-4 sm:mb-6">
          <h3 className="text-center text-sm sm:text-base font-semibold mb-2 sm:mb-3">
            Formation
          </h3>
      ...
      <div className="flex justify-center gap-2 mb-4 sm:mb-6">
        <button
          ...
          className={`px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-semibold transition-all ${
            view === "pitch"
              ? "bg-green-600 text-white"
            ...
            <div className="space-y-2 sm:space-y-3">
              {squad.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  No players selected. Add players to build your squad!
                </div>
              ) : (
                squad.map((p) => (
                  <div
                    key={p.id}
                    className="flex items-center justify-between p-2 sm:p-3 bg-white dark:bg-gray-800 rounded-lg shadow"
                  >
                    ...
                    <button
                      ...
                      className="px-2 py-1 sm:px-3 sm:py-1 bg-red-500 text-white rounded hover:bg-red-600 text-xs sm:text-sm"
                    >
                      Remove
                    </button>
                  </div>
